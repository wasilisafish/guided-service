                ...
                <div className="flex items-center gap-3 mb-6">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setPrimaryHomeChecked(checked as boolean)
                    }
                    className="w-5 h-5"
                  />
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setVehicleChecked(checked as boolean)
                      }
                      className="w-5 h-5"
                    />
                    ...
                    <div className="ml-8 space-y-4">
                      ...
                      <div className="bg-white border border-neutral-gray-30 rounded-lg overflow-hidden">
                        <div className="flex items-center border-b border-neutral-gray-10">
                          ...
                          <div className="flex-1 px-4 py-3 font-semibold border-l border-neutral-gray-10">
                            BI limits
                          </div>
                          <div className="flex-1 px-4 py-3 font-semibold border-l border-neutral-gray-10">
                            UM | UIM
