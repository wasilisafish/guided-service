        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-80 border-r border-neutral-gray-10 bg-white overflow-y-auto p-6">
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-bold text-base mb-4">Your proposal summary</h3>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="border border-neutral-gray-30 bg-white rounded px-2 py-1">
                            <svg width="84" height="21" viewBox="0 0 84 21" fill="none">
                              <text x="2" y="15" fontSize="14" fontWeight="bold" fill="black">FOREMOST</text>
                            </svg>
                          </div>
                        </div>
                      </div>
            ...
            <div className="max-w-5xl mx-auto p-8 space-y-8">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h1 className="text-4xl font-bold mb-6">Review your insurance offer</h1>
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        <p className="text-lg mb-4">
                          I'm Maria, your <span className="font-semibold">[state]</span> licensed insurance advisor. I've helped{" "}
                          <span className="font-semibold">[#]</span> customers protect their most important belongings.
                        </p>
                  ...
                  <div className="ml-8">
                    <svg width="240" height="160" viewBox="0 0 240 160" fill="none">
                      {/* House illustration */}
                      <rect x="20" y="60" width="100" height="80" fill="#60A5FA" rx="4"/>
                      <path d="M20 60L70 20L120 60" fill="#3B82F6"/>
                      <rect x="45" y="90" width="20" height="30" fill="#1E3A8A"/>
                      <rect x="80" y="90" width="20" height="30" fill="#1E3A8A"/>
                      <rect x="55" y="110" width="20" height="30" fill="#93C5FD"/>
                      
                      {/* Car illustration */}
                      <ellipse cx="180" cy="130" rx="40" ry="20" fill="#60A5FA"/>
                      <rect x="150" y="100" width="60" height="30" fill="#3B82F6" rx="8"/>
